...
- eggd_conductor (cfg) - config file containing app ID for bcl2fastq, slack API token and DNAnexus auth token
...
<b>Optional keys in highest level of config include:
